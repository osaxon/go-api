...
func newTask(db *gorm.DB, opts ...gen.DOOption) task {
	...
	_task.DeletedAt = field.NewTime(tableName, "deleted_at")
	_task.Title = field.NewString(tableName, "title")
	_task.UserId = field.NewString(tableName, "user_id")
	_task.User = taskBelongsToUser{
		...
		Tasks: struct {
			...
			RelationField: field.NewRelation("User.Tasks", "models.Task"),
			User: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("User.Tasks.User", "models.User"),
			},
		},
	}
